        ...
        async with aiohttp.ClientSession() as client:
            while True:
                ...
                if s[ret_code]:
                    ...
                    elif s[ret_code] in self.ignore_codes:
                        pass
                    ...
                    if self.return_response_headers:
                        return s, response.elapsed, response.headers,
                    elif self.record_request_time:
                        return s, response.elapsed
                    else:
                        return s